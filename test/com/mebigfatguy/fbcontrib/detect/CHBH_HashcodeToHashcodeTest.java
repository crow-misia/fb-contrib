...
public class CHBH_HashcodeToHashcodeTest extends BaseFindBugsTest {

	@Test
	public void test() throws IOException, InterruptedException, ClassNotFoundException {
		final EasyBugReporter reporter = new EasyBugReporter();
		analyze(reporter, Class.forName(getClass().getSimpleName().replace("Test", "Sample")));

		reporter.printResults();

		expect(reporter, new TreeMap<String, Integer>() {{
			put("CHTH_COMMONS_HASHCODE_BUILDER_TOHASHCODE", 1);
		}});
	}
