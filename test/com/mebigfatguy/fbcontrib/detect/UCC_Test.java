...
public class UCC_Test extends BaseFindBugsTest {
	...
	public void test() throws IOException, InterruptedException, ClassNotFoundException {
		...
		expect(reporter, new TreeMap<String, Integer>() {{
			put("ABC_ARRAY_BASED_COLLECTIONS", 1);
			put("DMI_HARDCODED_ABSOLUTE_FILENAME", 1);
			put("DM_NUMBER_CTOR", 1);
			put("FCBL_FIELD_COULD_BE_LOCAL", 1);
			put("SIC_INNER_SHOULD_BE_STATIC_ANON", 1);
			put("UCC_UNRELATED_COLLECTION_CONTENTS", 3);
