...
public class SNG_Test extends BaseFindBugsTest {
	...
	public void test() throws IOException, InterruptedException, ClassNotFoundException {
		...
		expect(reporter, new HashMap<String, Integer>() {{
			...
			put("DLS_DEAD_LOCAL_STORE_OF_NULL", 1);
			put("FCBL_FIELD_COULD_BE_LOCAL", 3);
			put("SNG_SUSPICIOUS_NULL_FIELD_GUARD", 1);
			put("SNG_SUSPICIOUS_NULL_LOCAL_GUARD", 1);
			put("URF_UNREAD_FIELD", 4);
		}});
	}
