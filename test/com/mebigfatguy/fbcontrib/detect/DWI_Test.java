...
public class DWI_Test extends BaseFindBugsTest {
	...
	public void test() throws IOException, InterruptedException, ClassNotFoundException {
		...
		expect(reporter, new TreeMap<String, Integer>() {{
			put("DWI_DELETING_WHILE_ITERATING", 1);
			put("DWI_MODIFYING_WHILE_ITERATING", 1);
			put("LSC_LITERAL_STRING_COMPARISON", 3);
			put("UWF_FIELD_NOT_INITIALIZED_IN_CONSTRUCTOR", 1);
		}});
	}
