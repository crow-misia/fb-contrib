...
public class JAO_Test extends BaseFindBugsTest {
	...
	public void test() throws IOException, InterruptedException, ClassNotFoundException {
		...
		expect(reporter, new TreeMap<String, Integer>() {{
			put("JAO_JUNIT_ASSERTION_ODDITIES_ACTUAL_CONSTANT", 1);
			put("JAO_JUNIT_ASSERTION_ODDITIES_ASSERT_USED", 1);
			put("JAO_JUNIT_ASSERTION_ODDITIES_BOOLEAN_ASSERT", 1);
			put("JAO_JUNIT_ASSERTION_ODDITIES_IMPOSSIBLE_NULL", 2);
			put("JAO_JUNIT_ASSERTION_ODDITIES_INEXACT_DOUBLE", 1);
		}});
	}
