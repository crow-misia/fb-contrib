...
public class LEST_Test extends BaseFindBugsTest {
	...
	public void test() throws IOException, InterruptedException, ClassNotFoundException {
		...
		expect(reporter, new TreeMap<String, Integer>() {{
			put("AFBR_ABNORMAL_FINALLY_BLOCK_RETURN", 1);
			put("DLS_DEAD_LOCAL_STORE", 6);
			put("EXS_EXCEPTION_SOFTENING_NO_CONSTRAINTS", 3);
			put("LEST_LOST_EXCEPTION_STACK_TRACE", 4);
			put("MDM_THREAD_YIELD", 1);
			put("REC_CATCH_EXCEPTION", 1);
			put("WEM_WEAK_EXCEPTION_MESSAGING", 2);
		}});
	}
