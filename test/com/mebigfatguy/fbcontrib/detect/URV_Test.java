...
public class URV_Test extends BaseFindBugsTest {

	@Test
	public void test() throws IOException, InterruptedException, ClassNotFoundException {
		final EasyBugReporter reporter = new EasyBugReporter();
		analyze(reporter,
				Class.forName("URV_Super"),
		...
		expect(reporter, new HashMap<String, Integer>() {{
			put("DM_NUMBER_CTOR", 1);
			put("URV_CHANGE_RETURN_TYPE", 1);
			put("URV_INHERITED_METHOD_WITH_RELATED_TYPES", 1);
			put("URV_UNRELATED_RETURN_VALUES", 1);
		}});
	}
