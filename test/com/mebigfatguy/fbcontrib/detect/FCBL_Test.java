...
public class FCBL_Test extends BaseFindBugsTest {
	...
	public void test() throws IOException, InterruptedException, ClassNotFoundException {
		...
		expect(reporter, new TreeMap<String, Integer>() {{
			put("CI_CONFUSED_INHERITANCE", 1);
			put("FCBL_FIELD_COULD_BE_LOCAL", 2);
			put("LSC_LITERAL_STRING_COMPARISON", 4);
			put("URF_UNREAD_FIELD", 2);
			put("URF_UNREAD_PUBLIC_OR_PROTECTED_FIELD", 2);
		}});
	}
