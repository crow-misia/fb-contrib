...
public class SG_Test extends BaseFindBugsTest {
	...
	public void test() throws IOException, InterruptedException, ClassNotFoundException {
		...
		expect(reporter, new TreeMap<String, Integer>() {{
			...
			put("DLS_DEAD_LOCAL_STORE_SHADOWS_FIELD", 1);
			put("DM_DEFAULT_ENCODING", 2);
			put("MDM_STRING_BYTES_ENCODING", 1);
			put("NP_ALWAYS_NULL_EXCEPTION", 1);
			put("REC_CATCH_EXCEPTION", 3);
			put("SG_SLUGGISH_GUI", 1);
		}});
	}
