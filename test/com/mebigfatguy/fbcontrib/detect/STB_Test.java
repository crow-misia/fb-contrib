...
public class STB_Test extends BaseFindBugsTest {
	...
	public void test() throws IOException, InterruptedException, ClassNotFoundException {
		...
		expect(reporter, new TreeMap<String, Integer>() {{
			put("DLS_DEAD_LOCAL_STORE", 22);
			put("LEST_LOST_EXCEPTION_STACK_TRACE", 12);
			put("OS_OPEN_STREAM", 12);
			put("STB_STACKED_TRY_BLOCKS", 3);
			put("WEM_WEAK_EXCEPTION_MESSAGING", 6);
		}});
	}
