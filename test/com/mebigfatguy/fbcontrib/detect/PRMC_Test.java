...
public class PRMC_Test extends BaseFindBugsTest {
	...
	public void test() throws IOException, InterruptedException, ClassNotFoundException {
		...
		expect(reporter, new HashMap<String, Integer>() {{
			put("BC_EQUALS_METHOD_SHOULD_WORK_FOR_ALL_OBJECTS", 1);
			put("DLS_DEAD_LOCAL_STORE", 2);
			put("HE_EQUALS_USE_HASHCODE", 1);
			put("LSC_LITERAL_STRING_COMPARISON", 1);
			put("NP_UNWRITTEN_FIELD", 1);
			put("PRMC_POSSIBLY_REDUNDANT_METHOD_CALLS", 4);
			put("UWF_UNWRITTEN_FIELD", 1);
