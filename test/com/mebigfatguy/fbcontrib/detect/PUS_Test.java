...
public class PUS_Test extends BaseFindBugsTest {
	...
	public void test() throws IOException, InterruptedException, ClassNotFoundException {
		...
		expect(reporter, new HashMap<String, Integer>() {{
			put("FCBL_FIELD_COULD_BE_LOCAL", 6);
			put("OS_OPEN_STREAM_EXCEPTION_PATH", 1);
			put("PUS_POSSIBLE_UNSUSPECTED_SERIALIZATION", 1);
			put("SE_INNER_CLASS", 1);
			put("SE_NO_SERIALVERSIONID", 3);
