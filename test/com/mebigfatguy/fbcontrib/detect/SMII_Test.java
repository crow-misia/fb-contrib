...
public class SMII_Test extends BaseFindBugsTest {
	...
	public void test() throws IOException, InterruptedException, ClassNotFoundException {
		...
		expect(reporter, new HashMap<String, Integer>() {{
			...
			put("DM_CONVERT_CASE", 1);
			put("FCBL_FIELD_COULD_BE_LOCAL", 2);
			put("IL_INFINITE_RECURSIVE_LOOP", 2);
			put("ISC_INSTANTIATE_STATIC_CLASS", 1);
			put("PRMC_POSSIBLY_REDUNDANT_METHOD_CALLS", 1);
			put("SMII_STATIC_METHOD_INSTANCE_INVOCATION", 3);
			put("URF_UNREAD_FIELD", 2);
