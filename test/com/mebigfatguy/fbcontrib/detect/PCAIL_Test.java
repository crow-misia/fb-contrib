...
public class PCAIL_Test extends BaseFindBugsTest {
	...
	public void test() throws IOException, InterruptedException, ClassNotFoundException {
		...
		expect(reporter, new HashMap<String, Integer>() {{
			...
			put("PCAIL_POSSIBLE_CONSTANT_ALLOCATION_IN_LOOP", 2);
			put("PSC_PRESIZE_COLLECTIONS", 3);
			put("SA_LOCAL_SELF_COMPARISON", 1);
			put("URF_UNREAD_FIELD", 1);
			put("WOC_WRITE_ONLY_COLLECTION_LOCAL", 4);
		}});
	}
